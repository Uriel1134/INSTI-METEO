...
class _AirQualityState extends State<AirQuality> {
  double aqi = 150;
  String pollutant = "PM 18";
  String commentAQI = "Bon";
  String meaning = "La qualité de l'air est jugée satisfaisante et la pollution ne pose aucun risque.";

  void updateAQI(double newValue, String newPollutant) {
    setState(() {
      aqi = newValue;
      pollutant = newPollutant;
      commentAQI = getAQIComment(aqi);
      meaning = getAQIMeaning(aqi);
    });
  }

  String getAQIComment(double value) {
  ...
  String getAQIMeaning(double value) {
      ...
      body: Stack(
        children: [
          ...
          SingleChildScrollView(
            child: Column(
              children: [
                SizedBox(height: MediaQuery.of(context).size.height * 0.1), // Espacement initial
